...
// actor 
Actor::Actor(int imageID, int x, int y, int dir, double size, unsigned depth)
...
//ice
Ice::Ice(int x, int y) : Actor(IID_ICE, x, y, right, 1.0, 3){}
Ice::~Ice() {}
void Ice::doSomething() { /* ice is inert */ }

// iceman
Iceman::Iceman(int x, int y, StudentWorld* w)
: Actor(IID_PLAYER, x, y, right, 1.0, 0), m_world(w){}
Iceman::~Iceman(){}
